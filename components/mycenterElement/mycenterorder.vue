<template>
  <el-card class="box-card" body-style="border-radius: 4px"
           style="width: 900px;background-color: #F7F9F9;border-color: #F7F9F9" shadow="shadow">
            ...
            <el-col :span="24" v-for="d in dfkdindanDate">
              <div class="grid-content bg-purple"
                ...
                <div v-for="del_goods in d.del_goods">
                  <el-row>
                    <el-col :span="4">
                      <el-image :src="'http://localhost:8081/src/assets/'+del_goods.goods.gimgs"
                                style="width: 100px;height: 100px;padding-left: 10px"></el-image>
                    </el-col>
                ...
                <el-row>
                  <el-col push="1">
                    <a class="ddxqlikai" v-on:mouseover="ddxqmouseover($event)" v-on:mouseout="ddxqmouseout($event)"
                       @click="getDfkDindanXqDate(d.did)">查看详情>></a>&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;
            ...
            <el-col :span="24" v-for="d in dthdindanDate">
              ...
              <div class="grid-content bg-purple"
                ...
                <el-row>
                  ...
                  <el-col push="1"><br>
                    <a class="ddxqlikai" v-on:mouseover="ddxqmouseover($event)" v-on:mouseout="ddxqmouseout($event)"
                       @click="getDshDindanXqDate(d.did)">查看详情>></a>&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;
                    <el-button size="small " style="background-color: #F75211;color: white;width: 87px;height: 30px"
                               @click="userQrSh(d.did)">确认收货
                    </el-button>
                  </el-col>
                </el-row>
                <br>
              ...
              <div class="grid-content bg-purple"
                ...
                <el-row>
                  <el-col push="1" span="20">
                    <a class="ddxqlikai" v-on:mouseover="ddxqmouseover($event)" v-on:mouseout="ddxqmouseout($event)"
                       @click="getYwcDindanXqDate(d.did)">查看详情>></a>
                  </el-col>
      ...
      <el-row style="border: 1px dashed darkgrey;">
        ...
        <el-col v-for="del_goods1 in ywcddxqData.del_goods">
          <div>
            <el-row>
              <el-col :span="5">
                <el-image :src="'http://localhost:8081/src/assets/'+del_goods1.goods.gimgs"
                          style="width: 120px;height: 120px;padding-left: 10px"></el-image>
              </el-col>
              <el-col :span="6" style="padding-top: 40px">
